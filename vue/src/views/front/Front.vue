    ...
    <div style="display: flex; height: 60px; line-height: 60px; border-bottom: 1px solid #eee">
      <div style="width: 300px; display: flex; padding-left: 30px">
        <div style="width: 60px">
          <img src="../../assets/logo1.png" alt="" style="width: 200px; position: relative; top: 8px; right: 0">
        </div>
        <div style="flex: 1; margin-top: 22px"></div>
      </div>
      <div style="flex: 1">
<!--        导航菜单-->
...
<!--        </ul>-->
        ...
        <el-menu :default-active="'1'" class="el-menu-demo" mode="horizontal" router>
          ...
          <el-menu-item index="/front/article">文章列表</el-menu-item>
            <el-menu-item index="/home">我的工作台</el-menu-item>
<!--          <el-submenu index="2">-->
...
<!--          </el-submenu>-->
          ...
          <el-menu-item index="4"><a href="http://www.dangdang.com" target="_blank">订单管理</a></el-menu-item>
        </el-menu>
      </div>
      <div style="width: 200px">
        <div v-if="!user.username" style="text-align: right; padding-right: 30px;margin-top: 22px">
