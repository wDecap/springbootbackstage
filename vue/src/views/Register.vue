                    ...
                    <el-form :model="user" :rules="rules" ref="userForm">
                        <el-form-item prop="username">
                            <div class="userbox">
                                ...
                                <el-input v-model="user.username" type="text"  placeholder="用户名"></el-input>
                            </div>
                        </el-form-item>
                        <br>
                        ...
                        <el-form-item>
                            <el-button  class="register_btn" autocomplete="off" @click="login">注册</el-button>
                            <el-button  class="login_btn" autocomplete="off" @click="$router.push('/login')">返回</el-button>
                        </el-form-item>
                    </el-form>
                </div>
